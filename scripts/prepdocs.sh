...
python3 -m venv scripts/.venv #added python3 to make sure it uses python3

echo 'Installing dependencies from "requirements.txt" into virtual environment'
./scripts/.venv/bin/python3 -m pip install -r scripts/requirements.txt
#Older versions of python may need to use "./scripts/.venv/bin/python -m pip3 install -r scripts/requirements.txt"
